...
func TestOutputsForCsvBasicExampleAndForVmSeries(t *testing.T) {
	...
	// expected_addresses := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/addresses.csv", 2)
	// expected_addr_groups := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/addr_groups.csv", 2)
	// expected_ike_crypto_profiles := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/ike_crypto_profiles.csv", 2)
	// expected_ike_gateways := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/ike_gateways.csv", 2)
	...
	// expected_ipsec_crypto_profiles := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/ipsec_crypto_profiles.csv", 2)
	// expected_ipsec_tunnels := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/ipsec_tunnels.csv", 2)
	...
	// expected_nat := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/nat.csv", 2)
	// expected_policy := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/policy.csv", 2)
	// expected_service_groups := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/service_groups.csv", 2)
	// expected_services := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/services.csv", 2)
	// expected_tags := ReadCsvFileAndReturnListOfValuesFromColumn("../examples/csv_examples/csv_basic_example/csv/tags.csv", 2)

...
| <a name="input_vsys"></a> [vsys](#input\_vsys) | Used in variable panorama is true, it gives possibility to choose Device Group for the deployment | `list(string)` | <pre>[<br>  "vsys1"<br>]</pre> | no |
